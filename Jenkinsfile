pipeline {
    ...
    environment {
        ...
        //IMAGE_NAME = "wimetrixcregistery/frontend"
        GIT_CREDENTIALS_ID = "GithubCredentials"
        SOURCE_REPO = "github.com/WiMetrixDev/sooperwizer.git"
        WORKSPACE_DIR = "/home/jenkins/deployment-package/wimetrix/Nishat-frontend"
        GITHUB_REPO = 'github.com/WiMetrixDev/dep-Nishat-frontend.git'
    ...
    stages {
        ...
        steps {
            ...
            checkout([$class: 'GitSCM',
                    ...
                    extensions: [
                        [$class: 'WipeWorkspace'],
                        [$class: 'RelativeTargetDirectory', relativeTargetDir: '/home/jenkins/deployment-package/wimetrix/Nishat-frontend']
                    ],
                    submoduleCfg: [],
                    userRemoteConfigs: [[
                        credentialsId: 'GithubCredentials',
                        url: 'https://github.com/WiMetrixDev/dep-Nishat-frontend.git'
                    ]]
            ])
            ...
            checkout([$class: 'GitSCM',
                    ...
                    extensions: [
                        [$class: 'WipeWorkspace'],
                        [$class: 'RelativeTargetDirectory', relativeTargetDir: '/home/jenkins/deployment-package/wimetrix/Nishat-frontend/source']
                    ],
                    submoduleCfg: [],
                    userRemoteConfigs: [[
                        credentialsId: 'GithubCredentials',
    ...
    steps {
        script {
            def dockerfileDir = '/home/jenkins/deployment-package/wimetrix/Nishat-frontend/'
            ...
            withCredentials([
                    ...
                    sh label: '', script: '''
                        cp /home/jenkins/deployment-package/wimetrix/Nishat-frontend/Dockerfile /home/jenkins/deployment-package/wimetrix/Nishat-frontend/source/
                        cp /home/jenkins/deployment-package/wimetrix/Nishat-frontend/.dockerignore /home/jenkins/deployment-package/wimetrix/Nishat-frontend/source/
                        cd /home/jenkins/deployment-package/wimetrix/Nishat-frontend/source/shared-env/web
                        cp ${SECRET_FILE} /home/jenkins/deployment-package/wimetrix/Nishat-frontend/source/shared-env/web/.env.production
                '''
                dockerImage = docker.build("${REGISTRY_URL}/${IMAGE_NAME}:${env.BUILD_ID}",
                    "-f ${sourceDir}/Dockerfile ${sourceDir}")

                sh label: '', script: '''
                rm -rf /home/jenkins/deployment-package/wimetrix/Nishat-frontend/source/*
                ''' 
                    }                 
            }
        }
            ...
            steps {
                script {
                    withCredentials([string(credentialsId: 'GITHUB_ACTIONS_SECRET', variable: 'GITHUB_ACTIONS')]){
                        ...
                        def githubRepo = "dep-Nishat-frontend"  
